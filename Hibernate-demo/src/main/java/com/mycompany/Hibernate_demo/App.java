...
import com.mycompany.Hibernate_demo.dao.EmployeeDAO;
import com.mycompany.Hibernate_demo.dao.EmployeeDAOImpl;
...
public class App {
	public static void main(String[] args) {
		 ...
		 * 
		 * List<SharedEmployee> se = dao.getAllEmployee(); for (SharedEmployee see : se)
